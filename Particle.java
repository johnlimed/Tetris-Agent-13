...
public float[] personalBestVector; // the position/weight vector where it achieved the best score
public ParticleSwarmOptimization.FitnessAssessment personalBestFitness;

// the position vector supplied is used to determine the number of features/coordinates
